...
ruleTester.run("sort-keys", rule, {
    valid: [
        ...
        // asc, insensitive
        {code: "var obj = {_:2, a:1, b:3} // asc, insensitive", options: ["asc", {insensitive: true}]},
        {code: "var obj = {a:1, b:3, c:2}", options: ["asc", {insensitive: true}]},
        {code: "var obj = {a:2, b:3, b_:1}", options: ["asc", {insensitive: true}]},
        {code: "var obj = {b_:1, C:3, c:2}", options: ["asc", {insensitive: true}]},
        {code: "var obj = {b_:1, c:3, C:2}", options: ["asc", {insensitive: true}]},
        {code: "var obj = {$:1, _:2, A:3, a:4}", options: ["asc", {insensitive: true}]},
        {code: "var obj = {1:1, '11':2, 2:4, A:3}", options: ["asc", {insensitive: true}]},
        {code: "var obj = {'#':1, 'Z':2, À:3, è:4}", options: ["asc", {insensitive: true}]},
        ...
        {code: "var obj = {_:2, a:1, b:3} // asc, natural, insensitive", options: ["asc", {natural: true, insensitive: true}]},
        {code: "var obj = {a:1, b:3, c:2}", options: ["asc", {natural: true, insensitive: true}]},
        {code: "var obj = {a:2, b:3, b_:1}", options: ["asc", {natural: true, insensitive: true}]},
        {code: "var obj = {b_:1, C:3, c:2}", options: ["asc", {natural: true, insensitive: true}]},
        {code: "var obj = {b_:1, c:3, C:2}", options: ["asc", {natural: true, insensitive: true}]},
        {code: "var obj = {$:1, _:2, A:3, a:4}", options: ["asc", {natural: true, insensitive: true}]},
        {code: "var obj = {1:1, 2:4, '11':2, A:3}", options: ["asc", {natural: true, insensitive: true}]},
        {code: "var obj = {'#':1, 'Z':2, À:3, è:4}", options: ["asc", {natural: true, insensitive: true}]},
        ...
        // desc, insensitive
        {code: "var obj = {b:3, a:1, _:2} // desc, insensitive", options: ["desc", {insensitive: true}]},
        {code: "var obj = {c:2, b:3, a:1}", options: ["desc", {insensitive: true}]},
        {code: "var obj = {b_:1, b:3, a:2}", options: ["desc", {insensitive: true}]},
        {code: "var obj = {c:2, C:3, b_:1}", options: ["desc", {insensitive: true}]},
        {code: "var obj = {C:2, c:3, b_:1}", options: ["desc", {insensitive: true}]},
        {code: "var obj = {a:4, A:3, _:2, $:1}", options: ["desc", {insensitive: true}]},
        {code: "var obj = {A:3, 2:4, '11':2, 1:1}", options: ["desc", {insensitive: true}]},
        {code: "var obj = {è:4, À:3, 'Z':2, '#':1}", options: ["desc", {insensitive: true}]},
        ...
        {code: "var obj = {b:3, a:1, _:2} // desc, natural, insensitive", options: ["desc", {natural: true, insensitive: true}]},
        {code: "var obj = {c:2, b:3, a:1}", options: ["desc", {natural: true, insensitive: true}]},
        {code: "var obj = {b_:1, b:3, a:2}", options: ["desc", {natural: true, insensitive: true}]},
        {code: "var obj = {c:2, C:3, b_:1}", options: ["desc", {natural: true, insensitive: true}]},
        {code: "var obj = {C:2, c:3, b_:1}", options: ["desc", {natural: true, insensitive: true}]},
        {code: "var obj = {a:4, A:3, _:2, $:1}", options: ["desc", {natural: true, insensitive: true}]},
        {code: "var obj = {A:3, '11':2, 2:4, 1:1}", options: ["desc", {natural: true, insensitive: true}]},
        {code: "var obj = {è:4, À:3, 'Z':2, '#':1}", options: ["desc", {natural: true, insensitive: true}]},
    ],
    invalid: [
        ...
        // asc, natural, insensitive
        {
            ...
            options: ["asc", {natural: true, insensitive: true}],
            errors: [
        ...
        // desc, natural, insensitive
        {
            ...
            options: ["desc", {natural: true, insensitive: true}],
            errors: [
